  ...
  <div class="col-md-6">
    ...
    <div class="box box-primary">
      ...
      <tr>
        ...
        <td><a href="#" class="fied-required editable editable-click" data-name="time_active" data-type="text" data-pk="" data-source="" data-url="{{ route('admin_store_info.update') }}" data-title="{{ trans('store_info.time_active') }}"data-original-title="" title="">{{$infos->time_active }}</a></td>
      </tr>

      <tr>
        <td>{{ trans('store_info.address') }}</td>
        <td><a href="#" class="fied-required editable editable-click" data-name="address" data-type="text" data-pk="" data-source="" data-url="{{ route('admin_store_info.update') }}" data-title="{{ trans('store_info.address') }}"  data-original-title="" title="">{{$infos->address }}</a></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><a href="#" class="fied-required editable editable-click" data-name="email" data-type="text" data-pk="" data-source="" data-url="{{ route('admin_store_info.update') }}"   data-original-title="" title=""></a></td>
      </tr>
  ...
  <tr>
    ...
    <td>
      @foreach ($infoDescription as $codeLanguage => $des)
        ...
        <i><a href="#" class="fied-required editable editable-click" data-name="{{ $obj.'__'.$codeLanguage }}" data-type="text" data-pk="" data-source="" data-url="{{ route('admin_store_info.update') }}" data-title="{{ trans('store_info.'.$obj) }}" data-original-title="" title=""></a></i><br>
        <br>
      @endforeach
    </td>
  </tr>
