       ...
       <table class="table table-hover">
        ...
        <tr>
          ...
          <tr>
            ...
            <td><a href="#" class="fied-required editable editable-click" data-name="ADMIN_NAME" data-type="text" data-pk="" data-source="" data-url="{{ route('admin_store_value.update') }}" data-title="{{ trans('env.ADMIN_NAME') }}" data-original-title="" title=""></a></td>
          </tr>
          <tr>
            <td>{{ trans('env.ADMIN_TITLE') }}</td>
            <td><a href="#" class="fied-required editable editable-click" data-name="ADMIN_TITLE" data-type="text" data-pk="" data-source="" data-url="{{ route('admin_store_value.update') }}" data-title="{{ trans('env.ADMIN_TITLE') }}"  data-original-title="" title=""></a></td>
          </tr>
          <tr>
            <td>{{ trans('env.ADMIN_LOGO') }}</td>
            <td><a href="#" class="fied-required editable editable-click" data-name="ADMIN_LOGO" data-type="text" data-pk="" data-source="" data-url="{{ route('admin_store_value.update') }}" data-title="{{ trans('env.ADMIN_LOGO') }}"  data-original-title="" title=""></a></td>
          </tr>
          <tr>
